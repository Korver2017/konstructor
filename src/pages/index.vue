              ...
              >
                <ul class="navbar-nav navbar-nav-hover mx-auto">
                  <li class="nav-item dropdown dropdown-hover mx-2">
                    ...
                    <div
                      class="dropdown-menu dropdown-menu-animation dropdown-xl p-3 border-radius-xl mt-0 mt-lg-3"
                        ...
                        <div class="col-12 px-4 py-2">
                          <div class="row">
                            <div class="col-4 position-relative">
                              ...
                              >
                                <span class="ps-3"
                                  >Podcast
                                  <span
                                    class="badge badge-sm bg-gradient-dark ms-1"
                                    >NEW</span
                                  ></span
                                >
                              </a>
                            ...
                            <div class="col-4">
                              ...
                              <a
                                href="./pages/digital-agency.html"
                                class="dropdown-item border-radius-md"
                              >
                                <span class="ps-3"
                                  >Digital Agency
                  ...
                  <li class="nav-item dropdown dropdown-hover mx-2">
                    ...
                    <div
                      class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3"
                      ...
                      <div class="d-none d-lg-block">
                        <ul class="list-group">
                          <li class="nav-item list-group-item border-0 p-0">
                            <a
                              class="dropdown-item py-2 ps-3 border-radius-md"
                              href=" https://www.creative-tim.com/learning-lab/bootstrap/overview/soft-ui-design-system "
                            >
                              <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                                  <svg
                          ...
                          <li class="nav-item list-group-item border-0 p-0">
                            <a
                              class="dropdown-item py-2 ps-3 border-radius-md"
                              href=" https://www.creative-tim.com/learning-lab/bootstrap/colors/soft-ui-design-system "
                            >
                              <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                                  <svg
                          ...
                          <li class="nav-item list-group-item border-0 p-0">
                            <a
                              class="dropdown-item py-2 ps-3 border-radius-md"
                              href=" https://www.creative-tim.com/learning-lab/bootstrap/alerts/soft-ui-design-system "
                            >
                              <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                                  <svg
                          ...
                          <li class="nav-item list-group-item border-0 p-0">
                            <a
                              class="dropdown-item py-2 ps-3 border-radius-md"
                              href=" https://www.creative-tim.com/learning-lab/bootstrap/datepicker/soft-ui-design-system "
                            >
                              <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                                  <svg
                          ...
                          <li class="nav-item list-group-item border-0 p-0">
                            <a
                              class="dropdown-item py-2 ps-3 border-radius-md"
                              href=" https://www.creative-tim.com/learning-lab/bootstrap/utilities/soft-ui-design-system "
                            >
                              <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                                  <svg
          ...
          <div class="row">
            <div class="col-lg-7 text-center mx-auto">
              ...
              <p class="lead text-white mt-3">
                Simple and innovative Web UI Kit built on top of Bootstrap 5.
                <br />
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
            <div
              class="card card-background card-background-mask-primary tilt"
              data-tilt
            >
              <div
              ...
              <div class="card-body pt-7 text-center">
                ...
                <a
                  href=".//sections/page-sections/hero-sections.html"
                  target="_blank"
                  class="btn btn-outline-white btn-lg mt-3 up btn-round"
      ...
      <div class="mt-lg-n8 mt-n6">
        <div class="container">
          <div class="row mt-5">
            <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
              <div class="card shadow-none border h-100">
                ...
                >
                  ...
                  <a
                    href="https://secure.avangate.com/order/checkout.php?PRODS=34081148&amp;OPTIONS34081148=FREELANCER&amp;CART=1&amp;CARD=2&amp;CLEAN_CART=1&amp;SHORT_FORM=1&amp;SRC=soft-ds-pro-presentation"
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex pb-3">
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Full code</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Projects - 1</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Team Size - 1</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                  ...
                  <div class="d-flex pb-3">
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Free Updates - 6 months</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
              <div class="card shadow-none border h-100">
                ...
                >
                  ...
                  <a
                    href="https://secure.avangate.com/order/checkout.php?PRODS=34081148&amp;OPTIONS34081148=STARTUP&amp;CART=1&amp;CARD=2&amp;CLEAN_CART=1&amp;SHORT_FORM=1&amp;SRC=presentation"
                    class="btn btn-sm bg-gradient-dark w-100 border-radius-md mt-4 mb-2"
                    >Buy now</a
                  >
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex pb-3">
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Team Size - up to 5</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                  ...
                  <div class="d-flex pb-3">
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Free Updates - 12 months</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
              <div
                class="card shadow-none border bg-gradient-dark h-100 overflow-hidden"
              >
                <img
                ...
                >
                  ...
                  <a
                    href="https://secure.avangate.com/order/checkout.php?PRODS=34081148&amp;OPTIONS34081148=COMPANY&amp;CART=1&amp;CARD=2&amp;CLEAN_CART=1&amp;SHORT_FORM=1&amp;SRC=soft-ds-pro-presentation"
                ...
                <div class="card-body z-index-2">
                  ...
                  <div class="d-flex pb-3">
                    ...
                    <div class="ps-3">
                      <span class="text-sm text-white">Full code</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                    ...
                    <div class="ps-3">
                      <span class="text-sm text-white">Use in SaaS</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
            ...
            <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
              <div class="card shadow-none border h-100">
                ...
                >
                  ...
                  <a
                    href="https://secure.avangate.com/order/checkout.php?PRODS=34081148&amp;OPTIONS34081148=ENTERPRISE&amp;CART=1&amp;CARD=2&amp;CLEAN_CART=1&amp;SHORT_FORM=1&amp;SRC=soft-ds-pro-presentation"
                    class="btn btn-sm bg-gradient-dark w-100 border-radius-md mt-4 mb-2"
                    >Buy now</a
                  >
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex pb-3">
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Use in SaaS</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Projects - unlimited</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Developers - more than 20</span>
                    </div>
                  </div>
                  <div class="d-flex pb-3">
                    <div>
                  ...
                  <div class="d-flex pb-3">
                    ...
                    <div class="ps-3">
                      <span class="text-sm">Free Updates - 24 months</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-md-7 col-12 my-auto">
            ...
            <p class="pe-md-5 mb-4">
              ...
              before purchasing it? It features enough basic components and
              sections for you to get a feel of the design and also test the
              quality of the code. Get it free on GitHub!
            </p>
          ...
          <div class="col-md-5 col-12 my-auto">
            ...
            >
              <img
                ...
                src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/opt_sds_free_thumbnail.jpg"
                alt="Product Image"
              />
            </a>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 col-md-12 ms-auto order-1 order-md-1 order-lg-1">
            <div class="p-3 pt-0">
              <div
                class="icon icon-shape bg-gradient-primary rounded-circle shadow text-center mb-4"
              >
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 me-lg-auto my-lg-auto text-lg-end mt-5">
            <a
              href="https://twitter.com/intent/tweet?text=Check%20Soft%20UI%20Design%20System%20made%20by%20%40CreativeTim%20%23webdesign%20%23designsystem%20%23bootstrap5&url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fsoft-ui-design-system-pro"
            ...
            <a
              href="https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com/product/soft-ui-design-system-pro"
            ...
            <a
              href="https://www.pinterest.com/pin/create/button/?url=https://www.creative-tim.com/product/soft-ui-design-system-pro"
          ...
          <div class="col-12">
            <div class="text-center">
              <p class="my-4 text-sm">
                All rights reserved. Copyright © Soft UI Design System by
