  ...
  <header>
    ...
    <section class="py-6 position-relative overflow-hidden">
      <img
        ...
        alt="pattern-lines"
        class="position-absolute opacity-6 top-0 w-100 z-index-1"
      />
            ...
            <div class="row py-5">
              <div class="col-xl-4 col-md-6 px-5 position-relative">
                <img
                  ...
                  src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/tired.jpg"
                />
              </div>
              <div
                class="col-xl-4 col-md-5 z-index-2 position-relative px-md-3 px-5 my-auto"
              >
                <div>
                  <svg
                    class="opacity-2"
              ...
              <div class="col-1"></div>
              <div
                class="col-xl-2 col-12 px-xl-0 px-5 my-xl-auto position-relative z-index-1"
              >
                ...
                <a
                  href="javascript:;"
                  class="text-primary icon-move-right text-sm"
                  >See all products
